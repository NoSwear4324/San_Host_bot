    ...
    if (command === 'help') {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '-setstats @user <count>', value: 'Set total robux count for a user', inline: false },
                { name: '-seteventstats @user <type> <count>', value: 'Change event stats for a user', inline: false },
